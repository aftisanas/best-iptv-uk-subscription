  ...
  const handleBuyNow = async () => {
    ...
    try {
      ...
      if (response.kind === "shopify") {
        ...
        // it's a method call so it doesn't trip react-hooks/immutability.
        window.location.assign(response.checkoutUrl);
        return;
      }

      // Store was claimed between page load and click — switch UI, don't
        ...
        <div className="grid gap-6 lg:grid-cols-[360px_minmax(0,1fr)] lg:gap-8 items-start">
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            ...
            <div className="rounded-2xl border border-violet-100/60 bg-white p-6 shadow-lg shadow-purple-900/5">
              ...
              {promoNotice && <p className="mt-2 text-xs text-muted">{promoNotice}</p>}
            </div>
          </div>
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setExtraConnections((v) => Math.min(EXTRA_CONNECTIONS_MAX, v + 1))
                        }
            ...
            <section className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    First name{" "}
                    <span className="font-normal text-muted">(first or last required)</span>
                  </label>
                  <input
              ...
              <div>
                ...
                {!phoneValid && (
                  <p className="mt-1.5 text-[11px] leading-relaxed text-red-600">
                    That doesn&apos;t look like a valid phone number. Please check and try
                    again, or leave it blank.
                  </p>
                )}
                <p
