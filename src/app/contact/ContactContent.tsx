    ...
    <div>
      ...
      <section className="relative overflow-hidden pt-28 pb-20 lg:pt-36 lg:pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            The Best IPTV UK support crew is staffed around the clock across live chat, email and WhatsApp — named British agents with direct knowledge of the British broadcaster market. Average first response sits under four minutes.
          </motion.p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-foreground">Best IPTV UK Support Hours</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-foreground">Where The Best IPTV UK Team Can Help</h3>
              </div>
