...
const DEVICE_CARDS: DeviceCard[] = [
  {
    ...
    icon: Flame,
    blurb: "Allow unknown apps, sideload the player and activate your Best IPTV UK line in two minutes.",
  },
  {
    id: "samsung-tv",
      ...
      <section className="relative overflow-hidden pt-28 pb-20 lg:pt-36 lg:pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <span className="font-medium">Best IPTV UK Activation Centre</span>
          </motion.div>
          ...
          >
            Plain-English walkthroughs for getting your Best IPTV UK subscription live on
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">
              ...
              <span className="gradient-text">Straight To Its Best IPTV UK Guide</span>
            </h2>
            <p className="mx-auto max-w-xl text-lg text-muted">
              Step-by-step Best IPTV UK install guides for every device — choose the card that
              matches your screen.
            </p>
          </motion.div>
      ...
      <section id="android-tv" className="relative py-11 lg:py-16 scroll-mt-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              Type the <strong>username, password and server URL</strong> from your Best
              IPTV UK welcome email.
            </TutorialStep>
          </ol>
        </div>
      </section>
      ...
      <section id="android-phone" className="relative py-11 lg:py-16 scroll-mt-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              Enter the <strong>username, password and server URL</strong> from your Best
              IPTV UK welcome email.
            </TutorialStep>
          </ol>
        </div>
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              ...
              <strong>username, password and server URL</strong> from your Best IPTV UK
              welcome email.
            </TutorialStep>
            <TutorialStep>
          ...
          <VideoEmbed
            title="Best IPTV UK — IPTV Smarters Pro on Firestick"
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              ...
              <strong>username, password and server URL</strong> from the Best IPTV UK
              welcome email.
            </TutorialStep>
          </ol>
          ...
          <VideoEmbed
            title="Best IPTV UK — Smarters Player Lite on iOS"
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              ...
              URL from your Best IPTV UK welcome email.
            </TutorialStep>
          </ol>
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              After installing, follow the video below to add the M3U link from your Best
              IPTV UK welcome email.
            </TutorialStep>
          </ol>
          ...
          <VideoEmbed
            title="Best IPTV UK — KODI M3U setup"
        ...
        <div className="mt-10 pt-8 border-t border-violet-100">
          ...
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <TutorialStep>
              ...
              and upload the M3U link from your Best IPTV UK welcome email using that MAC
              address.
            </TutorialStep>
            <TutorialStep>
          ...
          <VideoEmbed
            title="Best IPTV UK — Smart IPTV on Samsung"
