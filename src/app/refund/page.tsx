...
export const metadata: Metadata = {
  ...
  description: `${SITE_NAME} refund policy. Every first purchase is covered by a no-questions 30-day refund.`,
    ...
    <div className="pt-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">30-Day Money-Back Promise</h2>
            <p>{SITE_NAME} backs every first subscription with an unconditional 30-day refund. If picture quality, channel coverage or any other promise fails to land inside the first month, the full amount returns same-day.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Requesting A Refund</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Processing Times</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">Refund Boundaries</h2>
