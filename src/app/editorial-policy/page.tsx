...
const relatedGuides: SubPageRelatedGuide[] = [
  ...
  },
  {
    ...
    description:
      "The legal framework applied when evaluating services, sourced against CDPA 1988 and Ofcom guidance.",
  },
  {
    href: "/best-iptv-uk-2026",
    title: "Best IPTV UK 2026 — Buyer's Framework",
    description:
...
const faqItems: SubPageFAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Best IPTV UK Editorial is operated by the team that also runs the recommended service listed on this site. That relationship is disclosed on every page that recommends the service. The buyer's framework at /best-iptv-uk-2026 was written before any specific service was recommended against it — the criteria are the same criteria a competing operator would face.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Every cluster page and blog post carries a datePublished and dateModified in schema and in the visible byline. Guides are reviewed at minimum every 90 days. Pages affected by regulatory change (Ofcom updates, CDPA amendments, ISP filtering shifts) are updated within 30 days of the change being confirmed.",
  },
];
...
export default function EditorialPolicyPage() {
  return (
    ...
    >
      ...
      <p>
        Best IPTV UK Editorial publishes evidence-led coverage of the UK IPTV
        market. The site is operated by the team that also runs the recommended
        service listed at{" "}
        <Link href="/">best-iptv-uk-subscription.com</Link>. That relationship
      ...
      <p>
        ...
        <Link href="/best-iptv-uk-2026">/best-iptv-uk-2026</Link>: channel
        coverage, uptime and infrastructure, refund window, 4K UHD availability,
        device support, GBP-denominated pricing, and provable point of contact.
        Criteria that require a subjective judgement (design taste, brand
        aesthetics, marketing polish) are excluded — they are not verifiable and
        therefore not reproducible by a reader running the same test.
      </p>
      ...
      <p>
        Every cluster page is reviewed at minimum every 90 days. Pages affected
