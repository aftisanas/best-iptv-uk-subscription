...
import { SITE_NAME, WHATSAPP_DISPLAY, WHATSAPP_NUMBER } from "@/lib/constants";
  ...
  return (
    <div className="pt-20">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="rounded-2xl border border-[color:var(--color-border)] bg-white p-8 sm:p-10 shadow-2xl shadow-[rgba(30,20,60,0.10)]">
          <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-[color:var(--color-success)]/10">
            <CheckCircle2 className="h-8 w-8 text-[color:var(--color-success)]" aria-hidden="true" />
          </div>
          ...
          <div
            role="note"
            className="mb-6 rounded-xl border border-[color:var(--color-neon)]/40 bg-[color:var(--color-neon)]/10 px-4 py-3 text-xs leading-relaxed text-foreground"
          >
          ...
          <div className="mb-8">
            ...
            <Link
              href="/tutorials"
              className="flex items-center gap-3 rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-primary)]/5 px-4 py-3 transition-colors hover:bg-[color:var(--color-primary)]/10"
            >
              <PlayCircle className="h-5 w-5 shrink-0 text-[color:var(--color-primary)]" aria-hidden="true" />
              <div>
                <div className="text-sm font-semibold text-foreground">Setup guides</div>
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/"
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-[color:var(--color-primary)] focus-visible:outline-offset-2"
            >
              Back to {SITE_NAME}
            </Link>
          </div>
