...
export const FEATURES = [
  ...
  {
    title: "Best IPTV UK Secure Proxy Add-On — £1.58/Month",
    description:
      "An optional Secure Proxy add-on encrypts your stream traffic and reduces ISP-side filtering. £1.58/month across every plan — paid upfront with your term (£4.75 on 3-month, £9.50 on 6-month, £19.00 on 12-month, £38.00 on 24-month).",
...
export const COMPARISON_ROWS = [
  ...
  { feature: "Secure Proxy Option", ours: "Add-on £1.58/mo", typical: "Rarely offered", unlicensed: "No" },
...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      "Secure Proxy add-on: £4.75 (£1.58/mo)",
      "30-day money-back guarantee",
      "Credentials delivered in under 2 minutes",
    ],
    popular: false,
    savings: null,
  },
  {
    ...
    features: [
      ...
      "Support all devices",
      "24/7 dedicated UK support",
      "Secure Proxy add-on: £9.50 (£1.58/mo)",
      "30-day money-back guarantee",
      "Credentials delivered in under 2 minutes",
    ],
    popular: false,
  ...
  },
  {
    ...
    features: [
      ...
      "Support all devices",
      "24/7 dedicated UK support",
      "Secure Proxy add-on: £19.00 (£1.58/mo)",
      "30-day money-back guarantee",
      "Credentials delivered in under 2 minutes",
    ],
    popular: true,
  ...
  },
  {
    ...
    features: [
      ...
      "Support all devices",
      "24/7 dedicated UK support",
      "Secure Proxy add-on: £38.00 (£1.58/mo)",
      "30-day money-back guarantee",
      "Credentials delivered in under 2 minutes",
    ],
    popular: false,
