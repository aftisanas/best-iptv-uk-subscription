...
export const TUTORIAL_DEVICES_EXTRA: TutorialDevice[] = [
  ...
  },
  {
    ...
    steps: [
      {
        text: "We currently don't support legacy MAG boxes (MAC-address-only registration). For the best Best IPTV UK experience, we recommend upgrading to:",
        substeps: [
...
export const QUICK_FIX_CHECKLIST: QuickFixItem[] = [
  ...
  },
  {
    ...
    description:
      "If you have an external VPN running, turn it off and test again. Best IPTV UK's Secure Proxy add-on is the recommended option — it won't conflict.",
  },
  {
...
export const TROUBLESHOOTING_ITEMS: TroubleshootingItem[] = [
  ...
  },
  {
    ...
    steps: [
      "Recommended: enable Best IPTV UK's Secure Proxy add-on (available at checkout) — it reduces ISP-side stream interference and won't conflict with your apps.",
  ...
  },
  {
    ...
    steps: [
      "Recommended: enable Best IPTV UK Secure Proxy to bypass the ISP filter.",
